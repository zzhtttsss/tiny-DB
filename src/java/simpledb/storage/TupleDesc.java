...
public class TupleDesc implements Serializable {
    ...
    public String toString() {
        ...
        for(int i = 0;i < tdItems.length - 1;++i){
            sb.append(tdItems[i].fieldName).append("(").append(tdItems[i].fieldType).append("), ");
        }
        sb.append(tdItems[tdItems.length - 1].fieldName).append("(").append(tdItems[tdItems.length - 1].fieldType).append(")");
        return sb.toString();
    }
}
